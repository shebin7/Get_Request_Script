...
try:
    ...
    def Rest_Get():
        ...
        if "IOS-XE" in Device_Platform:
            ...
            console.print('Sorry IOS-XR currently not available',style='bold red')
            pass
        ...
        try:
            ...
            with open(get_module_csv,'r') as dr:
                ...
                if "IOS-XE" in Device_Platform:                    
                    console.print("[white]:right_arrow:[/white] Connecting to IOS-XE.....\n",style='bold yellow')       
                    ...
                    ###Login and Getting Data for the requested moduel by user ###
                    ...
                    console.print('[white]:right_arrow:[/white] Connected to IOS-XE !!!\n',style='bold green')
                    console.print('[white]:right_arrow:[/white] Requesting Data for the module...\n',style='bold purple')
                    ...
                    console.print("[white]:right_arrow:[/white] Connecting to NX-OS.....\n",style='bold yellow')                    
                    ...
                    console.print('[white]:right_arrow:[/white] Connected to NX-OS !!!\n',style='bold green')
  
                    ### Getting Data for the requested module by user ###
                    console.print('[white]:right_arrow:[/white] Requesting Data for the module...\n',style='bold purple')
                    ...
                    console.print('='*40)
                    time.sleep(1)
                    console.print(final_result,style='bold yellow')
    ...
    console.print("Error! Entered file or object not avialable",ne,style='bold red')
except KeyboardInterrupt as ki:
    console.print("Error! Sorry cannot Execute further..Your Execution stopped due to keyboard interupt",ki,style='bold red')
except Exception:
    console.print("Error! Some other problem occured ..Please look into it..",ki,style='bold red')
